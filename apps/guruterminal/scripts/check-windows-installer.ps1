...
try {
    ...
    $requiredFiles = @(
        ...
        (Join-Path $agentDir "skills\research\agents\openai.yaml"),
        (Join-Path $agentDir "skills\wiki\SKILL.md"),
        (Join-Path $agentDir "skills\wiki\agents\openai.yaml"),
        (Join-Path $agentDir "skills\lens\SKILL.md"),
        (Join-Path $agentDir "skills\lens\agents\openai.yaml"),
