...
- Remove host plugins, Packs, compatibility paths, and independent Core distribution.
- Add signed GitHub Releases and consent-based in-app updates.
- License the project under AGPL-3.0-only.
